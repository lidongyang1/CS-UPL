...
checkpoint = ModelCheckpoint(filepath='model/CS-GCN-LSTM_allUsers.h5', monitor='val_loss', mode='auto', save_best_only='True', verbose=1)
history = LossHistory()
...
history2 =  model.fit(
    [trainX_allUser,trainX_allUser,trainX_top_1_allUser,trainX_top_2_allUser,trainX_top_3_allUser],
    trainY_allUser,
    epochs=100,
    batch_size=512,
    shuffle=True,
    verbose=1,
    validation_data=[[testX_allUser,testX_allUser,testX_top_1_allUser,testX_top_2_allUser,testX_top_3_allUser], testY_allUser],
...
print(losses)
np.save('./model/losses/losses_allUsers.npy',losses)
