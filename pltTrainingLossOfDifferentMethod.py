...
oneUser_CS_GCN_LSTM = np.load('./losses/losses.npy')
oneUser_S_GCN_LSTM = np.load('./losses/S-GCN-LSTM_losses.npy')
oneUser_C_GCN_LSTM = np.load('./losses/C-GCN-LSTM_losses.npy')
oneUser_GCN_LSTM = np.load('./losses/GCN-LSTM_losses.npy')
AllUser_CS_GCN_LSTM = np.load('./losses/losses_allUsers.npy')
AllUser_S_GCN_LSTM = np.load('./losses/S-GCN-LSTM_losses_allUsers.npy')
AllUser_C_GCN_LSTM = np.load('./losses/C-GCN-LSTM_losses_allUsers.npy')
AllUser_GCN_LSTM = np.load('./losses/GCN-LSTM_losses_allUsers.npy')
